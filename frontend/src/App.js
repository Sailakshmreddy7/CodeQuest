...
import StudentFeedback from "./components/Faculty/StudentFeedback";
...
import SendFeedback from "./components/Student/SendFeedback";
...
function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={<LoggedIn element={<LandingPage />} />} />
        <Route
        ...
        <Route
          ...
          element={<PrivateRoute element={<AllFeedbacks />} />}
        />
        <Route
        ...
        />
        <Route
          path="/faculty/dashboard/student-feedback"
          element={<PrivateRoute element={<StudentFeedback />} />}
        />
        <Route
        ...
        />
        <Route
          path="/student/dashboard/course-selection"
          element={<PrivateRoute element={<CourseSelection />} />}
        />
        <Route
          path="/student/dashboard/send-feedback"
          element={<PrivateRoute element={<SendFeedback />} />}
        />
        <Route
