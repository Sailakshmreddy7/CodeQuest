    ...
    >
      <div>
        ...
        <ul className="nav nav-pills flex-column p-0 m-0">
          ...
          <li className="nav-item p-1">
            <Link
              to="/student/dashboard/course-selection"
              className="nav-link text-black"
            >
              <i className="bi bi-person-workspace me-2 fs-5"></i>
              <span className="fs-5">Course Selection</span>
            </Link>
          </li>

          <li className="nav-item p-1">
            <Link
              to="/student/dashboard/send-feedback"
              className="nav-link text-black"
            >
              <i className="bi bi-person-workspace me-2 fs-5"></i>
              <span className="fs-5">Send Feedback</span>
            </Link>
          </li>
