  ...
  useEffect(() => {
    ...
    setFilteredStudents(
      filtered.map((student) => ({
        ...student,
        courseName: courses.find((course) => course._id === student.course)
          ?.name,
      }))
    );
  ...
  return (
    <div className="d-flex justify-content-center">
      <div>
        ...
        <div
          className="mt-4 mx-5 p-4 pt-3 border border-3 border-success rounded-4"
          style={{ width: "42rem" }}
        >
          <Form>
          ...
          <div className="mt-3 border border-2 rounded-2 ">
            <div className="d-flex w-100">
              <Col xs={3} className="p-3 px-4 fw-bold">
                Name
              </Col>
              <Col xs={3} className="p-3 px-2 fw-bold">
                Course
              </Col>
              <Col xs={4} className="p-3 px-0 fw-bold">
                Email
              </Col>
            </div>
                  ...
                  >
                    <Row className="w-100">
                      ...
                      <Col xs={4} className="pt-3">
                        <p className="mb-0 text-muted overflow-auto">
                          {student.email}
                        </p>
                      </Col>
        ...
        <RemoveStudentModal
          ...
          handleClose={handleCloseRemoveStudentModal}
          setMessage={setMessage}
          handleShowToast={handleShowToast}
        />
        <UpdateStudentModal
          show={showUpdateStudentModal}
          handleClose={handleCloseUpdateStudentModal}
